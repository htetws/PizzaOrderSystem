            ...
            <div class="col-md-10 offset-1">
                ...
                <div class="row bg-white p-4 d-flex align-items-start">
                    <div class="col-3 ms-5 mt-4">
                        <input type="text" class="form-control text-center my-2 form-control-sm mb-3" value="Role : {{ ucfirst($user->role) }}" readonly>
                        <div class="image">
                            @if($user->image != null)
                    ...
                    <div class="col-7 offset-1">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Username" value="{{ old('name',$user->name) }}">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="Enter Phone Number" value="{{ old('phone',$user->phone) }}">
                            @error('phone')
                            <div class=" invalid-feedback">{{ $message }}
                            </div>
                            @enderror
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Enter address" value="{{ old('address',$user->address) }}">
                            @error('address')
                            <div class=" invalid-feedback">{{ $message }}
                            </div>
                            @enderror
