    ...
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="col-md-10 offset-1">
                ...
                <div class="alert col-6 offset-lg-6  alert-success alert-dismissible fade show" role="alert">
                ...
                <div class="row bg-white p-4 d-flex align-items-start">
                    <div class="col-3 ms-5 mt-4">
                        ...
                        <div class="image text-center">
                            ...
                            <img style="width:100%;min-height:15rem;object-fit:cover" src="{{ asset('storage/'. Auth::user()->image) }}" />
                            @else
